# PORTED from tests/test_derive_classification_domain.py @ 694ac4d08d0f98c322f050b2804894917cdeb64a (private job-cannon). Ledger L-0487.
...
# PORT-SEAM: json/logging/sqlite3 imports dropped -- only used by the two
# redrive-script tests removed below (scripts.redrive_classification is
# private-only, not ported).
import pytest
...
# PORT-SEAM: dropped test_redrive_batch_skips_malformed_and_continues and
# test_redrive_remediate_skips_malformed_row (+ _insert_scored_job helper,
# conn fixture) -- both import scripts.redrive_classification, a private-only
# DB-remediation script with no public counterpart.
