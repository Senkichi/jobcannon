# PORTED from job_finder/web/careers_page_interactions.py @ e218953fefd532d071482e3ff859610a46dd179d (private job-cannon). Ledger L-0166. Clean PORT, engine-local, no ScanServices seam.
...
# PORT-SEAM: field-alias imports moved from mid-file (after the Constants
# block, per private source layout) to the top-of-file import group here.
# Pure reordering for ruff E402 compliance -- no behavioral change (no
# circular import risk; _field_alias does not import back from this module).
...
def probe_url_params(
    ...
    # PORT-SEAM: import points directly at the real definer, _static_tier --
    # the private package-root re-export block (__init__.py:75-197) that
    # this import relied on is dropped in this port (design note deletion
    # set; this is the "seam-edit fix" PR #325 deferred, see its body)
    from jobcannon.engine.careers_crawler._static_tier import _extract_jobs_from_soup
