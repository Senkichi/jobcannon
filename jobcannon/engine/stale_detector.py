    ...
    with svc.connection_factory() as conn:
        try:
            ...
            unverifiable_rows = conn.execute(
                ...
                "j.direct_url_attempts, c.ats_scan_enabled, c.ats_probe_status "
                "FROM jobs j "
            ...
            for row in unverifiable_rows:
                ...
                ats_scan_enabled = row["ats_scan_enabled"]
                ...
                branch_matched = (
                    ...
                    or (company_id is not None and ats_scan_enabled == 0)  # Branch 2
