"""PORTED from job_finder/web/providers/cerebras_provider.py @ 9d57537f2f7100239181d34d0515cba342c83237
...
class CerebrasProvider(BaseProvider):
    ...
    def __init__(self, config: dict, *, resolve_credential: CredentialResolver) -> None:
        ...
        # get_secret("providers.api_keys.cerebras", config=config)
        self._api_key = resolve_credential("cerebras")
