# PORTED from job_finder/web/providers/gemini_provider.py @ 9678c44c5d667d8a1d587c2d1f92b9df4056ead9 (private job-cannon). Ledger L-0239.
...
from jobcannon.engine.model_provider import (
    BaseProvider,
    ModelResult,
