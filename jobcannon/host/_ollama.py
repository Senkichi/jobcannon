...
# operator-endpoint probe" scope. Re-raised as issue #362 item 4; the fold
# stays deferred — there is no ``providers/ollama_provider`` module in this
# repo to fold into (the provider catalog's "ollama" entry is a
# ``cli_binary`` ProviderSpec, not a probe owner, and the upstream
